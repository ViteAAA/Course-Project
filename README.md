# ДЛЯ МАШИ
_Маша, сделай проверки для критических тестов, пж ;)_
_Критические тесты в папке **data** называются **dataCritical**_

**products** - это все продукты

**productsCount** - это их количество

<br>
<br>
<br>
_Для правильного отображения и выполнения программы все файлы открывать в кодировке:_
`Windows-1251`
